...
def draw_floor():
    screen.blit(floor,(floor_x_pos,510))
    screen.blit(floor,(floor_x_pos+400,510))
def create_pipe():
...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        score_rect = score_surface.get_rect(center = (216,30))
        screen.blit(score_surface,score_rect)

        high_score_surface = game_font.render(f'High Score: {int(high_score)}',True,(255,255,255))
        high_score_rect = high_score_surface.get_rect(center = (216,495))
